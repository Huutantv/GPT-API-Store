...
function config() {
  return {
    ...
    autoBanMinutes: envInt(process.env.DORO_IPGUARD_AUTO_BAN_MINUTES, 20),
    multiKeyEnabled: envFlag(process.env.DORO_IPGUARD_MULTIKEY_ENABLED, true),
    maxKeysPerIp: envInt(process.env.DORO_IPGUARD_MAX_KEYS_PER_IP, 3),
    ...
    maxIpsPerKey: envInt(process.env.DORO_IPGUARD_MAX_IPS_PER_KEY, 3),
